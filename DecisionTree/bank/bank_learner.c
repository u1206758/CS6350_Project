//This program implements a decision tree learning algorithm for the car evaluation task in HW1 part 2 problem 3.
//Users can select information gain, majority error, or gini index, and optionally set a maximum depth from 1 to 16.
...
short numValues[NUM_ATTRIBUTES] = {2, 12, 3, 4, 2, 2, 2, 2, 3, 2, 12, 2, 2, 2, 2, 4};
