...
#define MAX_VAL 17
#define TREE_VAL 22
short numValues[NUM_ATTRIBUTES] = {4, 9, 4, 17, 4, 8, 15, 7, 3, 4, 4, 4};
//Precalculated thresholds (medians) of numerical attributes
float thresholds[3][NUM_ATTRIBUTES] = {{28,0,117179.25,0,9,0,0,0,0,0,0,40},
                                        {37,0,177299.5,0,10,0,0,0,0,0,0,40},
                                        {48,0,235657.25,0,12,0,0,0,0,0,0,45}};
...
bool isNumeric[NUM_ATTRIBUTES] = {true, false, true, false, true, false, false, false, false, true, true, true};
...
int main()
{
    ...
    printf("prediction error: %.2f%% \n\n", 100-((float) incorrectPredictions / (float) numInstances)*100);
